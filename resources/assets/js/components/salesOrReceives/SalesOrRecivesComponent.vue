            ...
            allProductDiscount(value, group, index, unformatted) {
                ...
                this.cart.forEach(function (element) {
                    if (element.quantity > 0) {
                        if(group == 2){
                            element.price = element.price_promotor;
                            element.discount = 0;
                            instance.discount = 0;
                        } else if(group == 3){
                            element.price = element.price_mayorista;
                            element.discount = 0;
                            instance.discount = 0;
                        }else{
                            element.price = element.unformPrice;
            ...
            addProductToCart(product, productVariantID) {
                ...
                if (flag == 0) {
                    ...
                    if (!_.isEmpty(insertCheckedVariant)) {
                        ...
                        if(instance.group == 2){
                            this.discount = 0;
                            var price = insertCheckedVariant[0].selling_price_promotor;
                        }else if(instance.group == 3){
                            this.discount = 0;
                            var price = insertCheckedVariant[0].selling_price_mayorist;
                        }else{
                            var price = insertCheckedVariant[0].price;
                            this.discount = 0;
                        }
                        this.cart.push({
                            ...
                            price: price,
                            price_promotor: insertCheckedVariant[0].selling_price_promotor,
                            price_mayorista: insertCheckedVariant[0].selling_price_mayorist,
            ...
            productBarcodedSearch() {
                ...
                if (productVariant != undefined) {
                    ...
                    let cart = {
                        ...
                        price_promotor: productVariant.selling_price_promotor,
                        price_mayorista: productVariant.selling_price_mayorist,
                ...
                if (this.barcodeSearch) {
                    ...
                    if (flag == 0) {
                        this.cart.push({
                            ...
                            price: data.price,
                            price_promotor: data.price_promotor,
                            price_mayorista: data.price_mayorista,
