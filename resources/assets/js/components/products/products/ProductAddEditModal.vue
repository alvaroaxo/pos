<template>
  <div>
    ...
    <div
      class="modal-body scroll-modal app-bg-color p-3"
      v-show="hidePreLoader"
    >
      <div class="form-row mx-0 mb-3 bg-white rounded p-3">
        <div class="form-group col-md-12">
          ...
          <div class="heightError" v-if="isTitleDuplicate">
            <small class="text-warning">{{
              trans('lang.product_name_is_duplicate')
            }}</small>
          </div>
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <div class="input-group">
            ...
            >
              ...
              <option v-for="unit in unitList" :value="unit.id">{{
                unit.name
              }}</option>
            </select>
            <div class="input-group-append">
        ...
        <div class="form-group col-md-6">
          ...
          >
            ...
            <option v-for="tax in taxList" :value="tax.id">{{
              tax.name
            }}</option>
          </select>
      ...
      <div
        class="form-row mx-0 mb-3 bg-white rounded p-3"
        v-if="!id && branchList.length > 0"
      >
        <div class="col-md-12 mb-3">
        ...
        <div class="form-group col-md-6" v-if="branchList.length > 1">
          <div v-if="initialQuantity == 1">
            ...
            >
              <option value disabled>{{ trans('lang.choose_one') }}</option>
              <option v-for="branch in branchList" :value="branch.id">{{
                branch.name
              }}</option>
            </select>
      ...
      <div v-if="!checkVariant" class="form-row mx-0 mb-3 bg-white rounded p-3">
        <div class="form-group col-md-3" v-if="hideCommonInput">
        ...
        <div class="form-group col-md-3" v-if="hideCommonInput">
          <label>Precio Promotor</label>
          <common-input
            v-if="hidePreLoader"
            name="sallingPricePromotor"
            id="'standard-product-salling-price-promotor'"
            step="any"
            :inputValue="decimalFormat(product.sallingPricePromotor)"
            @input="setSallingPromotorValue"
            :class="{
              'is-invalid': submitted && errors.has('sallingPricePromotor'),
            }"
          ></common-input>
        </div>
        ...
        <div class="form-group col-md-3" v-if="hideCommonInput">
          ...
          <common-input
            v-if="hidePreLoader"
            name="sallingPriceMayorista"
            id="'standard-product-salling-price-mayorista'"
            step="any"
            :inputValue="decimalFormat(product.sallingPriceMayorista)"
            @input="setSallingMayoristaValue"
            :class="{
              'is-invalid': submitted && errors.has('sallingPriceMayorista'),
            }"
          ></common-input>
        </div>
        ...
        <div class="form-group col-md-4">
          ...
          <div class="heightError">
            <small
              class="text-danger"
              v-show="
                sku.includes(standardProductSku) &&
                  standardProductSku != null &&
                  standardProductSku !== '' &&
                  checkSubmit
              "
        ...
        <div class="form-group col-md-4">
          <label for="standard-product-barcode">{{
            trans('lang.barcode')
          }}</label>
          <input
          ...
          <div class="heightError">
            <small
              class="text-danger"
              v-show="
                barcode.includes(standardProductBarcode) &&
                  standardProductBarcode != null &&
        ...
        <div class="form-group col-md-4" v-if="initialQuantity == 1">
          <label for="standard-product-quantity">{{
            trans('lang.quantity')
          }}</label>
          <input
                ...
                <div v-if="!id">
                  ...
                  >
                    <option selected disabled>{{
                      trans('lang.add_another_variant')
                    }}</option>
                    <option
                ...
                <div class="chips-container">
                  ...
                  >
                    ...
                    <i
                      ...
                      @click.prevent="
                        deleteChip($event, tempAttribute.id, chipIndex)
                      "
                    ></i>
                  </span>
                </div>
                <div class="input-group mb-2">
                  ...
                  <div class="input-group-append">
                    ...
                    <button
                      ...
                      v-if="!id"
                      @click.prevent="
                        removeTempAttribute(index, tempAttribute.id)
                      "
                    >
      ...
      <div
        ...
        v-if="productVariant.length > 0 && checkVariant"
      >
        <div class="form-row">
          <div class="form-group col-md-12">
            ...
            <thead>
              <tr class="border-0">
                ...
                <th class="text-center">
                  {{ trans('lang.purchase_price_label') }}
                </th>
                <th class="text-center">
                  {{ trans('lang.selling_price_label') }}
                </th>
                <th class="text-center">{{ trans('lang.barcode') }}</th>
                <th class="text-center">{{ trans('lang.sku') }}</th>
                <th v-if="initialQuantity == 1" class="text-center">
                  {{ trans('lang.quantity') }}
                </th>
              ...
              <tr v-for="(item, index) in productVariant">
                ...
                <td class="border-0 add-product-padding">
                  ...
                  <div class="heightError text-nowrap">
                    <small class="text-danger" v-show="item.isBarcodeExsist">{{
                ...
                <td class="border-0 add-product-padding">
                  ...
                  />
                  <div class="heightError text-nowrap">
                    <small class="text-danger" v-show="item.isSkuExsist">{{
                ...
                <td
                  class="border-0 add-product-padding"
                  v-if="initialQuantity == 1"
                >
                  <input
                ...
                <td class="border-0 add-product-padding">
                  <div class="custom-file" style="padding-right: 100%">
                    <input
                      ...
                      accept="image/*"
                      @change="
                        variantImage($event, index, '#variant-image-' + index)
                      "
                    />
                    <label
...
export default {
  ...
  data() {
    return {
      ...
      idCheck: '',
      sallingPrice: '',
      sallingPricePromotor: '',
      sallingPriceMayorista: '',
      receivingPrice: '',
      productQuantity: '',
  ...
  methods: {
    checkProductTitleDuplicate() {
      let instance = this,
        data = this.productData.find(function(element) {
          return (
            element.title.toLowerCase() === instance.product.pName.toLowerCase()
          );
        });
    ...
    isDublicateBarcodeOrSku() {
      let barcodeData = this.productVariant.find(function(element) {
        return element.isBarcodeExsist === true || element.isSkuExsist === true;
      });
    ...
    setSallingPromotorValue(amount) {
      this.product.sallingPricePromotor = amount;
    },
    setSallingMayoristaValue(amount) {
      this.product.sallingPriceMayorista = amount;
    },
      ...
      this.axiosGet(
        ...
        function(response) {
          ...
          if (instance.productsInfo.productDetails.product_type == 'standard') {
            ...
            instance.product.sallingPricePromotor =
              instance.productsInfo.variantDetails[0].sellingPricePromotor;
            instance.product.sallingPriceMayorista =
              instance.productsInfo.variantDetails[0].sellingPriceMayorista;
            ...
            instance.product.reorder = response.data.variantDetails[0].reOrder;
          } else {
            ...
            allAttributesProduct.forEach(function(value, index) {
              ...
              if (
                instance.productsInfo.variantData[arrribute_id] === undefined
              ) {
                deleteIndex.push(index);
              } else {
                instance.chipArray[arrribute_id] =
                  instance.productsInfo.variantData[arrribute_id];
              }
            });
    ...
    countVariant() {
          ...
          if (tempProductVariant.length == 0) {
            ...
            for (let t = 0; t < tempProductVariant.length; t++) {
              for (let j = 0; j < this.chipArray[i].length; j++) {
                let variantName =
                  tempProductVariant[t].variant + ',' + this.chipArray[i][j];
      ...
      if (this.id) {
        ...
        var diff = tempArr.filter(this.comparer(instance.productVariant));
        if (diff) {
          instance.productVariant = instance.productVariant.concat(diff);
        }
      } else {
        if (tempVariantDetails.length > 0) {
    ...
    save() {
      ...
      if (instance.checkVariant) {
        ...
        instance.productVariant.forEach(function(item, index, array) {
          ...
          let isTempBarcodeExsist = tempBarcode.includes(item.barcode);
          let isStoredBarcodeExsist = instance.barcode.includes(item.barcode);
          if (isTempBarcodeExsist || isStoredBarcodeExsist) {
            ...
            if (item.barcode != null) tempBarcode.push(item.barcode);
          }
        ...
        this.$validator.validateAll().then((result) => {
          if (
            ...
            if (instance.checkVariant) {
              ...
              instance.sallingPricePromotor = instance.pSellingPricePromotor;
              instance.sallingPriceMayorista = instance.pSellingPriceMayorista;
              ...
              instance.sallingPricePromotor =
                instance.product.sallingPricePromotor;
              instance.sallingPriceMayorista =
                instance.product.sallingPriceMayorista;
              ...
              instance.productQuantity = instance.standardProductQuantity;
            ...
            if (this.id) {
              this.postDataMethod('/products/edit/' + instance.id, {
                ...
                sallingPricePromotor: instance.sallingPricePromotor,
                sallingPriceMayorista: instance.sallingPriceMayorista,
