<template>
  <div>
    ...
    <div v-else>
      ...
      >
        <div
          class="modal-dialog modal-dialog-centered modal-xl modal-xxl"
          role="document"
        >
      ...
      <!--Print Barcode Modal-->
      <barcode-modal
        v-if="isProductBarcodeModalActive"
        @resetModal="resetModal"
