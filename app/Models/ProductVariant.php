...
{
    protected $fillable = ['sku', 'product_id', 'variant_title', 'attribute_values', 'variant_details', 'purchase_price', 'selling_price', 'selling_price_promotor', 'selling_price_mayorist', 'enabled', 'bar_code', 're_order', 'imageURL'];
...
//            ->leftJoin('product_groups', 'products.group_id', '=', 'product_groups.id')
    ...
    public static function getVariantByProductId($id)
    {
        return ProductVariant::select(
            ...
            'selling_price_promotor as sellingPricePromotor',
            'selling_price_mayorist as sellingPriceMayorista',
            'enabled',
            'imageURL',
            'bar_code as barcode',
            're_order as reOrder'
