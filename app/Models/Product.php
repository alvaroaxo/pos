...

{
    ...
    public static function getProductVariantsQuery($branchId, $orderType, $inStockOnly = 0, $returnProductId = false)
    {
        ...
        if ($orderType == 'sales') {
            ...
            $price_promotor = 'product_variants.selling_price_promotor  as price_promotor';
        }

        $fields = "product_variants.id, product_variants.sku, product_variants.product_id, product_variants.variant_title, product_variants.attribute_values, product_variants.enabled, product_variants.imageURL, product_variants.bar_code, product_variants.re_order, product_variants.purchase_price, product_variants.selling_price, $price, product_variants.selling_price_promotor, product_variants.selling_price_mayorist, order_items.qty AS availableQuantity";
    ...
    public static function getProducts($searchValue = '')
    {
        return Product::leftJoin('product_groups', 'products.group_id', '=', 'product_groups.id')
            ...
            ->select('products.id as productID', 'products.title', 'products.taxable', 'products.tax_type', 'products.tax_id', 'products.imageURL as productImage', 'product_variants.purchase_price as purchasePrice', 'product_variants.selling_price as sellingPrice', 'product_variants.selling_price_promotor as sellingPricePromotor','products.branch_id', 'product_groups.name as group_name', 'product_categories.name as category_name', 'product_brands.name as brand_name', 'product_variants.sku', 'product_variants.bar_code')
    ...
    public static function ifExists($field, $data)
    {
        ...
        return ProductVariant::select('product_variants.product_id as productId', 'product_variants.id as variantId', 'product_variants.purchase_price as purchase_price', 'product_variants.selling_price as selling_price', 'product_variants.selling_price_promotor as selling_price_promotor', 'products.title as title')
